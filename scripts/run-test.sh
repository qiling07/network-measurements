...
prefix_path=/home/ubuntu/measurement/prefixes
...
while read -r prefix; do
	...
	then
		...
		python3 ${scripts_path}/diamond-miner.py ${prefix} 10000 ${results_path}/${prefix_stripped}.dminer &>> ${results_path}/dminer.log
		python3 ${scripts_path}/diamond-miner.py ${prefix} 10000 ${results_path}/${prefix_stripped}.dminer2 &>> ${results_path}/dminer.log
	else
	...
	zmap ${prefix}  -M udp --probe-args=latency:0000 -p 53 -r 10000 -t 210 -c 5 -i eth0 \
	...
	zmap ${prefix}  -M udp --probe-args=latency:0000 -p 100 -r 10000 -t 210 -c 5 -i eth0 \
